            ...
            buttons: [
                {
                    label: 'Yes',
                    onClick: () =>
        axios.post(`${config.apiUrl}/updateTelentForApproved`, { 'email': id.email, 'user_id': id.user_id })
            .then(result => {
            ...
            buttons: [
                {
                    label: 'Yes',
                    onClick: () =>
        axios.post(`${config.apiUrl}/updateTelentForReject`, { 'email': id.email, 'user_id': id.user_id })
            .then(result => {
